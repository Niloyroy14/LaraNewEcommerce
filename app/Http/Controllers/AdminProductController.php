...
class AdminProductController extends Controller
{
   /* public function __construct()
    ...
    //karjee bootstrap with ajax product insert 

    public function product_image_create($id){

      
        //view()->share('id',$id);
        return view('admin.pages.product.create_product_image')->with('product_id',$id);
         
    }

    public function product_image_store(Request $request,$id){
    ...
    public function product_image_delete(Request $request,$id){
      ...
      // dd( $product_image);
         ...
         //delete from path
            $filename = $product_image->imagefile;
