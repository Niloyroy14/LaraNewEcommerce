...
use App\Notifications\NotifqyAdmin;
...
**/
    ...
    protected function register(Request $request)
    {
        ...
        //     'from'=>'22334400',
        //     'to'=> '+88'.$user['phoneno'],
        //      'text'=>'Dear ' .$user['username'] . 'your account is registered'
        //    ]);

         //for admin notify
         $admin = Admin::find(1);
         $admin->notify(new NotifqyAdmin($user));
        ...
        // Mail send with queue by redis (firstly redis install on windows)
