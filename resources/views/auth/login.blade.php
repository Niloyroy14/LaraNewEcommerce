                    ...
                    <div class="row mt-2">
                      <div class="col-md-6 offset-md-4">
                         <div class="social-auth-links text-center mt-2 mb-3">
                            ...
                            <a href="{{route('github.login')}}" class="btn btn-block btn-success">
                                <i class="fab fa-github mr-2"></i> Sign in using Github
                            </a>
                             <a href="{{route('linkedin.login')}}" class="btn btn-block btn-info">
                                <i class="fab fa-linkedin mr-2"></i> Sign in using Linkedin
                            </a>
                            <a href="{{route('instagram.login')}}" class="btn btn-block btn-danger">
