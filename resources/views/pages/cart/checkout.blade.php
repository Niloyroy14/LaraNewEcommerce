...
<div class="container mt-2 mb-5">
  ...
  @foreach(App\Models\Cart::totalCart()  as $cart)
   ...
   <h3>
   	{{ $cart->product->title}} - <strong>{{$cart->product->price}} Tk</strong>
  ...
  @endforeach
    ...
    @endforeach 
      ...
      <h5>Total Price : <span class="badge badge-success">{{$totalprice}} Tk</span></h5>
     

     <h5>Total Price With Shipping Cost : <span class="badge badge-danger">{{$totalprice + App\Models\Settings::first()->shipping_cost}} Tk</span> </h5>
