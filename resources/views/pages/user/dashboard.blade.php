...
<div class="container">
   ...
   <h2 style="text-align:center;">Welcome <span class="badge badge-success">{{ $user->username }}</span></h2>
   
   <h4 style="text-align:center;" class="mt-4"><span class="badge badge-warning">You can change your Profile and other information</span></h4>
  <div class="row">
