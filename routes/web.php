...
Route::get('google/login', 'Auth\LoginController@googleLogin')->name('google.login');
Route::get('google/callback', 'Auth\LoginController@googleLoginCallback')->name('google.login.callback');


//facebook login 

Route::get('facebook/login', 'Auth\LoginController@facebookLogin')->name('facebook.login');
Route::get('facebook/callback', 'Auth\LoginController@facebookLoginCallback')->name('facebook.login.callback');


//github login 

Route::get('github/login', 'Auth\LoginController@githubLogin')->name('github.login');
Route::get('github/callback', 'Auth\LoginController@githubLoginCallback')->name('github.login.callback');


//linkedin login 

Route::get('linkedin/login', 'Auth\LoginController@linkedinLogin')->name('linkedin.login');
Route::get('linkedin/callback', 'Auth\LoginController@linkedinLoginCallback')->name('linkedin.login.callback');

//instagram login 

Route::get('instagram/login', 'Auth\LoginController@instagramLogin')->name('instagram.login');
Route::get('instagram/callback', 'Auth\LoginController@instagramLoginCallback')->name('instagram.login.callback');



//livewire test

Route::get('/live/exam', 'LivewireController@index')->name('live.exam');
...
Route::get('/admin/product_image/create/{id}','AdminProductController@product_image_create')->name('admin.product_image.create');
Route::post('/admin/product_image/store/{id}','AdminProductController@product_image_store')->name('admin.product_image.store');
Route::post('/admin/product_image/delete/{id}','AdminProductController@product_image_delete')->name('admin.product_image.delete');
...
Route::post('/admin/product/import', 'AdminProductController@importProduct')->name('admin.product.import');

Route::get('/admin/product/export', 'AdminProductController@exportProduct')->name('admin.product.export');
...
Route::get('/admin/brand/data_table_list', 'AdminBrandController@dataTableList')->name('admin.brand.list');
